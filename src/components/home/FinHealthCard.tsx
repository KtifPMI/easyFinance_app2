...
export function FinHealthCard({ indicators }: { indicators: FinHealthIndicators }) {
  return (
...
const styles = StyleSheet.create({
  ...
  arc: { width: 54, height: 54, borderRadius: 27, borderWidth: 3, alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
  percent: { fontSize: 10, fontWeight: '700' },
  label: { ...typography.small, color: colors.textSecondary, textAlign: 'center' },
  hint: { ...typography.small, color: colors.textSecondary, marginTop: spacing.sm, textAlign: 'center' },
});
