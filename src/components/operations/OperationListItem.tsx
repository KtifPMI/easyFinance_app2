  ...
  return (
    <Pressable style={styles.row} onPress={onPress}>
      ...
      <Text style={[styles.amount, { color: amountColor }]}>
        {amountPrefix}{formatMoney(operation.amount, operation.currency)}
      </Text>
    </Pressable>
  );
}
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 40, height: 40, borderRadius: radius.round, alignItems: 'center', justifyContent: 'center', marginRight: spacing.md },
