import { Account, Budget, Category, FinancialEvent, Goal, Operation, Recommendation, Tag, User } from '../../types';
...
export const mockBudgets: Budget[] = [
  { id: 'b1', name: 'Продукты', categoryId: 'c1', limit: 20000, spent: 9800, period: 'monthly' },
  { id: 'b2', name: 'Транспорт', categoryId: 'c2', limit: 5000, spent: 2200, period: 'monthly' },
  { id: 'b3', name: 'Коммуналка', categoryId: 'c3', limit: 8000, spent: 6100, period: 'monthly' },
  { id: 'b4', name: 'Кафе и рестораны', categoryId: 'c6', limit: 4000, spent: 0, period: 'monthly' },
  { id: 'b5', name: 'Спорт и хобби', categoryId: 'c9', limit: 1500, spent: 890, period: 'monthly' },
];
